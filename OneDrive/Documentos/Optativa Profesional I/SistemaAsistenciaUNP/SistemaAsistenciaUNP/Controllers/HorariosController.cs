...
namespace SistemaAsistenciaUNP.Controllers
{
    public class HorariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HorarioId,DiaSemana,HoraInicio,HoraFin,Estado")] Horario horario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HorarioId,DiaSemana,HoraInicio,HoraFin,Estado")] Horario horario)
        {
